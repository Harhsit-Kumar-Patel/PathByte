        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/career-guide" className="text-slate-400 hover:text-white">Career Paths</Link></li>
              <li><Link to="/community" className="text-slate-400 hover:text-white">Community</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/privacy-policy" className="text-slate-400 hover:text-white">Privacy Policy</Link></li>
              <li><Link to="/terms-of-service" className="text-slate-400 hover:text-white">Terms of Service</Link></li>
            </ul>
          </div>
          <div>
