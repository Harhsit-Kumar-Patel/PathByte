        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in-up">
          ...
          <div className="text-center lg:hidden">
           ...
           <div className="text-center">
             <p className="text-sm text-slate-600 mb-4">Or continue with</p>
             <div className="grid grid-cols-2 gap-3">
               <button className="flex items-center justify-center px-4 py-3 bg-white border-2 border-slate-300 rounded-2xl text-slate-700 hover:bg-slate-50 hover:border-slate-400 hover:scale-105 transition-all duration-300 group">
